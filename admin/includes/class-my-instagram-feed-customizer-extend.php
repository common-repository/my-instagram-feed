...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Customize_Alpha_Color_Control' ) ):
	class Customize_Alpha_Color_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'alpha-color-picker', MIF_PLUGIN_URL . 'admin/assets/js/alpha-color-picker.js', [
					'jquery',
					'wp-color-picker',
				], '1.0.0', true );
			wp_enqueue_style( 'alpha-color-picker', MIF_PLUGIN_URL . 'admin/assets/css/alpha-color-picker.css', [ 'wp-color-picker' ], '1.0.0' );
		}
...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Customize_MIF_PopUp' ) ) :
	class Customize_MIF_PopUp extends WP_Customize_Control {
		...
		public function render_content() {
            ...
            <p><?php echo __( 'Upgrade today and get a 10% discount with coupon code <code>mif10</code>', 'my-instagram-feed' ) ?> </p>
            <a href="<?php echo mif_fs()->get_upgrade_url() ?>"
               class="fta-upgrade-btn"><?php echo __( 'Upgrade to pro', 'my-instagram-feed' ) ?></a>
